      ...
      {selectedCompany ? (
        ...
        <>
          ...
          <div className="ms-auto  d-flex">
            ...
            >
              ...
              <Row className="mt-4 text-center">
                {[
                  { title: "ALL AMOUNT COMPANIES", value: "14", detail: "" },
                  { title: "RECENTLY ADDED", value: "15", detail: "" },
                  {
                    title: "TOTAL AMOUNT OF COMPANIES",
                    value: "10",
                    detail: "",
                  },
                  {
                    title: "TOTAL NUMBER OF ADDED COMPANIES",
                    value: "5",
                    detail: "",
                  },
                  { title: "ACTIVE", value: "12", detail: "" },
                ].map((item, index) => (
                  <Col key={index}>
          ...
          <div className="card-body p-0">
            <QuotesTable
              dataSource={data}
              columns={columns(setSelectedCompany)}
              Selection={true}
            />
          </div>
        </>
