...
//                   <h6 className="fw-bold">
//                     <i
//                       className="fa-solid fa-arrow-right-arrow-left fa-rotate-by"></i> Relationships:
//                   </h6>
//                 </div>
//               </div>
...
//     <button
//       className="btn badge bg-primary btn-sm dropdown-toggle"
//       type="button"
...
const AddTask = () => {
  ...
  <div className="mb-3" style={{display: 'flex', alignItems: 'center'}}>
    <h6 className="fw-bold" style={{marginRight: '10px'}}>
      <i className="fas fa-info-circle"></i> Status:
    </h6>
  ...
  <div className="mb-3" style={{display: 'flex', alignItems: 'center'}}>
    <h6 className="fw-bold" style={{marginRight: '10px'}}>
      <i className="fa-solid fa-font-awesome" style={{ color: "#000000" }}></i> Priority:
    </h6>
    <input type="text" className="input-field" style={{ width: '100%'}}/>
  </div>
  <div className="mb-3" style={{display: 'flex', alignItems: 'center'}}>
  ...
  <div className="mb-3">
    <h6 className="fw-bold">
      <i className="fa-solid fa-arrow-right-arrow-left fa-rotate-by"></i> Relationships:
    </h6>
  </div>
</div>
          ...
          <div className="col-md-6">
            ...
            <table className="table table-bordered">
                    <tbody>
                      <tr>
                        ...
                        <td><input type="number"placeholder="Phone no" style={{width:"100%"
                        }}/></td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                        <input type="text"placeholder="Live" style={{width:"100%"
                        }}/>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td> <input type="text"placeholder="Organisation" style={{width:"100%"
                        }}/></td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td> <input type="text"placeholder="Project" style={{width:"100%"
                        }}/></td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td> <input type="email"placeholder="Email"style={{width:"100%"
                        }}/></td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td> <input type="text"placeholder="Contant Name"style={{width:"100%"
                        }}/></td>
                      </tr>
                      <tr>
                        <td>
            ...
            <div className="card d-flex flex-column mt-3" style={{height:"70%"}}>
              <div className="card-header fw-bold d-flex justify-content-between">
                <span>Activity</span>
                <div>
                  <i className="fas fa-search mx-2"></i>
