          ...
          <div className="">
            <div id="DataTables_Table_0_filter" className=" d-flex  ">
              <label className=" position-relative flex-right-1  " style={{
                ...
                />
                <i className="bi bi-search position-absolute" style={{ right: "12px", top: "27%", transform: "translateY(-50%)" }}></i>
              </label>
              <div className="search-actions d-flex flex-wrap">
                <p>Status:
                  <div className="btn-group">
                    <button className="btn" style={{ color: "#00aeff", fontWeight: "bold" }} data-bs-toggle="dropdown" aria-expanded="false">
                      All <i className="bi bi-box-arrow-up-right"></i>
                    </button>
