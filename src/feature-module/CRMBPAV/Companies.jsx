...
const data = [
  { id: 123, Name: "murtaza rasool", jobtitle: "--",email:"vrrr@",phone:"---" , company:"--" },
  { id: 33, Name: "Abdul", jobtitle: "--",email:"vrrr@" ,phone:"---" , company:"BPAV"},
    ...
    <div className="page-wrapper">
      ...
      <div className="filter-tabs">
        ...
        <div className=" d-flex  gap-3 flex-wrap">
          ...
          >
            Companies owner <i className="bi bi-chevron-down"></i>
          </button>
          <button
            className="btn btn-outline-secondary"
            style={{
